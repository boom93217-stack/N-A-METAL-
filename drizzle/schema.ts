...
/** Portfolio projects shown on the public Noman Builds website. */
export const projects = mysqlTable("projects", {
  ...
  coverImageKey: varchar("coverImageKey", { length: 700 }),
...
/** Additional gallery images for a portfolio project; file bytes remain in object storage. */
...
/** Messages submitted through the public Noman Builds contact form. */
